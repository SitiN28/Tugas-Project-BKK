...
{{-- 
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#alumni">Alumni</a></li>
          <li><a class="nav-link scrollto" href="#perusahaan">Perusahaan</a></li>
          <li><a class="nav-link scrollto" href="#posisi_pekerjaan">Posisi Pekerjaan</a></li>
          <li><a class="nav-link scrollto " href="#pendaftaran">Pendaftran</a></li>
  ...
  <!-- End Header -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary " >
        <div class="container-fluid">
          <a class="navbar-brand" href="#">BKK SMK YPC TASIKMALAYA</a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">Posisi Pekerjaan</a>
              </li>
              <li class="nav-item">
  ...
  <!-- ======= Hero Section ======= -->
  <div class="row">
    <section id="hero" class="d-flex align-items-center mt-3">
      <div class="container" data-aos="zoom-out" data-aos-delay="100">
        <h1 class="text-center mt-5">SELAMAT DATANG DI <span>BKK SMK YPC</span></h1>
        <h1 class="text-center">TASIKMALAYA</h1>
        {{-- <h6 class="text-center">Cari Pekerjaan Sesuai Keinginan dan Kemampuanmu</h6> --}}
        {{-- <div class="d-flex">
  ...
  <section id="Projects" class="pt-5">
    <div class="container">
      <div class="p-5 text-bg-light text-center">
        <h3 class="fw-bold mb-3">Lowongan Pekerjaan</h3>
        <div class="row justify-content-center">
          <div class="col-md-4 mb-3">
            <div class="card">
              <img src="{{ asset('img/huhhhhh.jpg') }}" class="card-img-top" alt="Project 1">
              <div class="card-body">
                <h4 class="card-text">Lowongan Kerja</h4>
                <p class="card-text mt-3">Kami perusahaan yang bergerak di bidang industri menawarkan 
                  lowongan kerja untuk menempati posisi sebagai : 
                </p>
                <h6 class="text-align">STAFF ACCOUNTING</h6>
                <p> - Pria/Wanita <br>
                    - Usia Minimal 20thn <br>
                    - Dapat mengoperasikan komputer <br>
                    - Pendidikan Minimal SMK/SMA
                </p>
                <p> Lamaran kerja dikirim langsung ke Jl.Cintawana Singaparna Tasikmalaya</p>
              </div>
            </div> 
          </div>
          <div class="col-md-4 mb-3">
            <div class="card">
              <img src="{{ asset('img/user.png') }}" class="card-img-top" alt="Project 2">
              <div class="card-body">
                <p class="card-text">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque aliquid vitae in sequi nesciunt, molestias voluptatibus sint quod quia eos eum reiciendis dolorem voluptate accusamus porro, pariatur maiores consectetur beatae.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4 mb-3">
            <div class="card">
              <img src="{{ asset('img/user.png') }}" class="card-img-top" alt="Project 3">
              <div class="card-body">
                <p class="card-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eum, ex rem molestiae placeat dolorem similique nesciunt odit id reprehenderit iusto in! Dolorem corporis voluptate optio, numquam vero labore neque facere.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              <h4>App 3</h4>
              <p>App</p>
              <a href="{{ asset('/iio-6.jpgmg/portfolio/portfol') }}" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="App 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
